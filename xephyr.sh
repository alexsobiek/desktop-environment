...
# =====================================================
# Modified script from lanrat
# https://gist.github.com/lanrat/7d14c9be56afbd4bc2ce
# =====================================================
...
build() {
  cd "$SCRIPT_DIR/panel/src-tauri" && cargo build
  cd "$SCRIPT_DIR"
}

setup_environment() {
  mkdir -p ~/.config/openbox
  echo "$SCRIPT_DIR/panel/src-tauri/target/debug/app" >> ~/.config/openbox/autostart.sh
